...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-7 col-stats">
                        <div class="numbers">
                          <p class="card-category">Total Akun Pelapor</p>
                          <h4 class="card-title"><?php echo number_format($total_user); ?></h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-stats card-info card-round">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-7 col-stats">
                        <div class="numbers">
                          <p class="card-category">Laporan Baru (Menunggu)</p>
                          <h4 class="card-title"><?php echo number_format($laporan_menunggu); ?></h4>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-7 col-stats">
                        <div class="numbers">
                          ...
                          <h4 class="card-title"><?php echo number_format($total_laporan); ?></h4>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-7 col-stats">
                        <div class="numbers">
                          ...
                          <h4 class="card-title"><?php echo number_format($laporan_selesai); ?></h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-round">
                  <div class="card-header">
                    ...
                    <p class="card-category">
                      Distribusi Status Laporan Saat Ini
                    </p>
                  </div>
    ...
    <script src="assets/js/demo.js"></script>
        ...
        const backgroundColors = <?php echo $chart_backgrounds; ?>;
        
        // Konfigurasi Chart.js
        const config = {
            type: 'pie', // Menggunakan chart Pie untuk visualisasi status
            data: {
                labels: labels,
                datasets: [{
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Distribusi Status Laporan Saat Ini'
                    }
                }
            }
        };
        ...
        // Render Chart
        const chartStatusLaporan = new Chart(
            document.getElementById('chartStatusLaporan'),
            config
        );
    </script>
  </body>
