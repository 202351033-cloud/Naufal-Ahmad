...
// --- TANGANI PESAN DARI PROSES LAIN (HAPUS/EDIT) ---
$pesan = "";
if (isset($_GET['success'])) {
    $pesan = "<p class='success-message'>" . htmlspecialchars($_GET['success']) . "</p>";
} elseif (isset($_GET['error'])) {
    $pesan = "<p class='error-message'>" . htmlspecialchars($_GET['error']) . "</p>";
}

// --- AMBIL DATA LAPORAN USER ---
$sql_laporan = "SELECT id, judul, kategori, tgl_kirim, status FROM laporan WHERE user_id = ? ORDER BY tgl_kirim DESC";
                  ...
                  <div class="card-body">
                    ...
                    <thead>
                        <tr>
                         ...
                         <tbody>
                         <?php 
                        // Loop untuk menampilkan semua laporan user
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="detail_laporan.php?id=<?php echo $row['id']; ?>&role=user" ><i class="fas fa-eye"></i></a>|
                                
                                <?php 
                                // Tombol Edit/Hapus hanya muncul jika status 'Menunggu'
                                if ($row['status'] == 'Menunggu'): 
                                ?>
                                    <a href="edit_laporan_user.php?id=<?php echo $row['id']; ?>" class="btn-edit"><i class="fa fa-edit"></i></a>|
                                    
                                    <a href="hapus_laporan.php?id=<?php echo $row['id']; ?>" 
                      ...
                      <?php else: ?>
                <p>Anda belum memiliki laporan. Silakan gunakan formulir di atas untuk memulai pengaduan.</p>
            <?php endif; ?>
                    </div>
                  </div>
                </div>
